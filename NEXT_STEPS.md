...
- [x] Integrate the official pinned `@okxweb3/x402-core@0.1.0` `OKXFacilitatorClient` with synchronous settlement, bounded timeouts, sanitized failures, and a read-only `npm run check:x402-support` command.
